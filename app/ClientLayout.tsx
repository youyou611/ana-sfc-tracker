    ...
    <div className="bg-slate-50 min-h-screen font-sans flex transition-colors duration-500">
      ...
      >
        ...
        <nav className="flex-1 py-6 space-y-2 overflow-y-auto overflow-x-hidden">
          <MenuItem href="/" iconPath="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" label="ダッシュボード" isOpen={isOpen} isActive={pathname === "/"} onClick={handleMenuClick} />
          <MenuItem href="/flight" iconPath="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" label="フライト予定・登録" isOpen={isOpen} isActive={pathname === "/flight"} onClick={handleMenuClick} />
          
          <div className="my-4 mx-4 border-t border-blue-800/50"></div>

          <MenuItem href="/guide" iconPath="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" label="SFC修行とは？" isOpen={isOpen} isActive={pathname === "/guide"} onClick={handleMenuClick} />
          <MenuItem href="/backup" iconPath="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" label="設定・バックアップ" isOpen={isOpen} isActive={pathname === "/backup"} onClick={handleMenuClick} />
        </nav>
      ...
      {/* メインコンテンツエリア */}
      <main className={`flex-1 w-full relative transition-[margin] duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${isOpen ? "ml-72" : "ml-20"}`}>
        {children}
      </main>
